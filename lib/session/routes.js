...
import { Session, Board, Player, Game } from '../../data/connectors';
...
app.post('/session/:id/pbn', function(req, res) {
  ...
  bridge.Session
    ...
    .then(session => {
      ...
      // TODO: What about players with same name.  Maybe scope to club?
      .then(() => {
        ...
        return Promise.all(actions)
          .then(() => console.log('players 2', players));
      })
